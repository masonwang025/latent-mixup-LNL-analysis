...
M_model_state_dict = torch.load(
    'noise_models/spiral_M-DYR-H/0.0/best_epoch_1_valLoss_1.89367_valAcc_54.12500_noise_0_bestAccVal_54.12500.pth')
LRM_model_state_dict = torch.load(
    'noise_models/spiral_LRM-DYR-H/0.0/best_epoch_1_valLoss_1.29694_valAcc_55.62500_noise_0_bestAccVal_55.62500.pth')
